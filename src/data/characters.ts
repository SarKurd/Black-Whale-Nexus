...
export const characters: Character[] = [
  ...
  },
  {
    ...
    bio: "One of Tserriednich's five genuine academy friends and the group's most disciplined strategist. Abducted into Morena's negotiation game, she identified the hideout and its rules, then deliberately entered the Heil-Ly under coercion while planning to resist from within.",
    monogram: "BO",
