...
export const events: StoryEvent[] = [
  ...
  },
  {
    ...
    kind: "battle",
    locationId: "tier-3",
    participantIds: ["hinrigh", "lynch", "zakuro", "bille", "perigord"],
    storylineIds: ["mafia-war", "heil-ly-morena"],
    knowledgeChanges: [
      {
        factId: "fact-morena-contagion",
  ...
  },
  {
    ...
    participantIds: ["hinrigh", "ken-i", "maizan", "gateaume"],
    storylineIds: ["heil-ly-morena", "mafia-war"],
    knowledgeChanges: [
  ...
  // -------------------------------------------------------------------------
  // Ch 415 — "Authenticity", day 12
  // -------------------------------------------------------------------------
  {
    id: "ev-415-curse-discovered",
    title: "Furykov has known all along",
    summary:
  ...
  },
  {
    ...
    evidence: [
      {
        chapter: 419,
        note: "The before/after-activation kill accounting is his own monologue, twice — 'I killed four guys — left, right, and two in front, before activation!' and 'the shots I actually fired were three on my right, one on my left. I shot four guys!!' — with the corpse shield ('I shift the corpse and return fire') and the named activation drawn on-page.",
        confidence: "canonical",
      },
    ],
    confidence: "canonical",
  ...
  },
  {
    ...
    title: "Emergency: Tier 1 on lockdown",
    summary:
      "The military's answer to an enemy it cannot see is geometry: 'Emergency!! Tier 1 is shutting down!! The cruise ship will be on lockdown!!' — moving between floors, opening doors, and moving within corridors all forbidden until further instruction from the royal army. The connecting bridges are retracted from the lower tiers' side, over their moat. Tserriednich reads the plan at a glance: seal him into the cruise ship for a full sweep, with the three vital areas — the King's, the princes', and the VVIP quarters — already closed off, and the grunts left to search high and low until the 'Birdbrain' comes back up from below. He grades the response faster than expected ('it IS martial law, after all'), notes that at worst he can pretend he was in the rec hall the whole time, and adds a new requirement to the escape: a way to 'stay dead' through the search.",
    chapter: 419,
    day: 12,
    kind: "decision",
    locationId: "tier-1",
    ...
    consequences: [
      "Tier 1 becomes a sealed search grid: Route A is dead, the bridges are up, and every locked door now needs the ability or a gun",
      "The sweep runs on a clock he can read — until the 'Birdbrain' comes back up from below, the grunts can only search high and low",
    ],
    evidence: [
      {
        chapter: 419,
        note: "The emergency broadcast text, the retracted bridges, and his three-vital-areas read are all on-page.",
        confidence: "canonical",
      },
    ],
    confidence: "canonical",
  },
  {
    ...
    summary:
      "The re-planned line off Tier 1, drawn over the deck's first proper map — the VVIP rec hall with its downstairs, the banquet hall, the King and Queens' quarters, and the bridge out to Tier 2: get downstairs from the rec hall, then escape to Tier 2 across the connecting bridge. He expects to spend Laplace's Devil twice more — 'for the showdown' on the rec hall's only route downstairs, and again at the connecting bridge — and names the worst stretch: crossing the port from the bridge, where the greener recruits are deployed and their patterns are hardest to predict. The casino's emergency exit should be a spiral staircase built to prevent unruly mobs swarming up from below, and therefore hold fewer men than the other routes; ideally he gets through using only guns, not the ability. The chapter closes with the officially dead Fourth Prince strolling into the gaming floor past machines numbered 4 and 9, two of his three lucky numbers, with the 6 conspicuously absent.",
    chapter: 419,
    day: 12,
    kind: "movement",
    locationId: "tier-1-casino",
    ...
    storylineIds: ["tserriednich-nen", "special-martial-law"],
    consequences: [
      "The escape reroutes through the VVIP entertainment district: casino, spiral staircase, connecting bridge, Tier 2",
